...
<head>
    ...
    <title>Download Free Latest Punjabi Video Songs</title>
    <style>
        section{
            width: 100%;
            padding: 1px;
...
<body>
    <section>
        ...
        <div class="latest_video">
            ...
            ?>
            <div class="row" id="nextpagevideo" onclick="window.location.href='nextpagevideo.php?code=<?php echo $data['video_id'] ?>'">
                <div class="col1">
                    <img src="../../partials/video/videobanner<?php echo $data['banner']?>" alt="">
            </div>
                <div class="col2">
                    <a href=""><?php echo $data['songName']?><span>[R]</span></a>
                    <p><?php echo $data['artistName']?></p>
                </div>
            </div>
            <?php 
            }
